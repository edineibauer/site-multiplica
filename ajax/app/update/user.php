...
$user = [
    "nome_de_usuario" => trim(strip_tags($dados['nome_de_usuario'] ?? null)),
...
unset($dados['nome_de_usuario'], $dados['telefone'], $dados['email'], $dados['status'], $dados['setor'], $dados['imagem'], $dados['nova_senha']);
